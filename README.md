...
## Дополнение 2026-07-13: материалы по родительским режимам

В `telegram/index.html` добавлены разделы из присланных DOCX:

- в разделе **Режимы**: рабочие тетради для заполнения по Требовательному родителю и Карающему критику;
- в разделе **Режимы**: блок «Слова критиков» с Наказывающим, Требовательным, Вводящим в вину и Отвергающим родителем;
- в разделе **Тело**: короткие практики, которые можно открыть в нужный момент;
- в разделе **Отношения**: конструктор «Я-сообщений» по 4 шагам.

VK и MAX версии не менялись: они заморожены до отдельного решения.
